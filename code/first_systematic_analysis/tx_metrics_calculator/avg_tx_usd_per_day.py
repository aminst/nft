...
if __name__ == "__main__": # usage: python avg_tx_usd_per_day.py <path_to_csv_day_files> <usd_file>
    ...
    for filename in filenames:
        ...
        for row in reader:
            ...
            count += 1
        print(count)
        usd_per_date[time] /= count
        print("DONE ", filename)
    
    write_volume_to_json('results/avg_tx_usd_per_day.json', usd_per_date)